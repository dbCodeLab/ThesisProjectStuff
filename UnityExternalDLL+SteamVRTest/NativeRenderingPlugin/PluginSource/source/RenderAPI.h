...
public:
	...
	virtual void DrawSimpleTriangles(const float worldMatrix[16], const float viewMatrix[16], const float projMatrix[16], int triangleCount, const void* verticesFloat3Byte4) = 0;
